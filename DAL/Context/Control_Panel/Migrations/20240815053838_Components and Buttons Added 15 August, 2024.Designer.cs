...
namespace DAL.Context.Control_Panel.Migrations
{
    ...
    [Migration("20240815053838_Components and Buttons Added 15 August, 2024")]
    partial class ComponentsandButtonsAdded15August2024
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shared.Domain.Control_Panel.Administration.Org_Config.Button", b =>
                {
                    ...
                    b.Property<string>("OnClickActionName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Shared.Domain.Control_Panel.Administration.Org_Config.Component", b =>
                {
                    b.Property<long>("ComponentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Shared.Domain.Control_Panel.Administration.Org_Config.Button", b =>
                {
                    b.HasOne("Shared.Domain.Control_Panel.Administration.Org_Config.Component", null)
                        .WithMany("Buttons")
